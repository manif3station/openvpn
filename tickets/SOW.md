...
Create a new `openvpn` skill that can capture OpenVPN credentials, optionally append a six-digit 2FA suffix, and keep the VPN tunnel connected through a DD collector-backed reconnect flow, with an explicit MIT license for reuse and distribution.
